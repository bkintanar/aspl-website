                    ...
                    <div class="row-fluid">
                        <div class="center">
                            <h1>
                                ...
                                <span class="red">automated</span>
                                <span class="white">SPL</span>
                            </h1>
                            <h4 class="blue">&copy; b3 Studios</h4>
                        </div>
                    </div>
                                    ...
                                    <div class="widget-main">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <button onclick="submit();" class="width-35 pull-right btn btn-small btn-primary">
                                                    <i class="icon-key"></i>
                                                    Login
                                                </button>
                                            </div>
